...
using IdentityService.Core.V1.Dtos;
...
using IdentityService.Infrastructure.V1.Database.Models;

using Microsoft.EntityFrameworkCore;

namespace IdentityService.Infrastructure.V1.Services.Information; 
