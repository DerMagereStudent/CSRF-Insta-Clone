...
export class HttpService {
  ...
  public async get(url: string, headers?: HttpHeaders): Promise<any> {
    return this.httpClient.get(url, { headers: headers}).toPromise().then(this.onRequestSucceeded.bind(this), this.onRequestFailed.bind(this));
  }

  public async post(url: string, body: any, headers?: HttpHeaders): Promise<any> {
    return this.httpClient.post(url, body, {headers: headers}).toPromise().then(this.onRequestSucceeded.bind(this), this.onRequestFailed.bind(this));
  }

  public async put(url: string, body: any, headers?: HttpHeaders): Promise<any> {
    return this.httpClient.put(url, body, {headers: headers}).toPromise().then(this.onRequestSucceeded.bind(this), this.onRequestFailed.bind(this));
  }

  public async delete(url: string, body: any, headers?: HttpHeaders): Promise<any> {
    return this.httpClient.delete(url, {body: body, headers: headers}).toPromise().then(this.onRequestSucceeded.bind(this), this.onRequestFailed.bind(this));
  }
